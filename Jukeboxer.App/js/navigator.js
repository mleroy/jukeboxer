    ...
    WinJS.Namespace.define("Application", {
        PageControlNavigator: WinJS.Class.define(
            ...
            function PageControlNavigator(element, options) {
                ...
                stage: "/pages/stage/stage.html",
                catalog: "/pages/catalog/catalog.html",
                ...
                // Retrieves a list of animation elements for the current page.
                // If the page does not define a list, animate the entire page.
                _getAnimationOffsets: function () {
                    if (this.pageControl && this.pageControl.getAnimationOffsets) {
                        return this.pageControl.getAnimationOffsets();
                    }
                    return undefined;
                },
                ...
                _navigated: function (args) {
                    ...
                    this._lastNavigationPromise = WinJS.Promise.timeout().then(function () {
                        ...
                        parentedComplete();
                        WinJS.UI.Animation.enterPage(this._getAnimationElements(), this._getAnimationOffsets()).done();
                    }.bind(this));
